...
public class RuntimeHelper {
    ...
    /**
     * Exec the arguments.just get the current app's logs.
     * @param args
     * @return
     * @throws IOException
     */
    public static Process execInMyApp(List<String> args) throws IOException {
    ...
    public static Process exec(List<String> args) throws IOException {
        ...
        // by cacard. I just want read my app's logs.
